(function ($) {
    ...
    if ($.fn.owlCarousel) {
        ...
        var gameSlide = $('.herogames-post-slides');
       ...
       welcomeSlide.owlCarousel({
        ...
        gameSlide.on('translate.owl.carousel', function () {
            var slideLayer = $("[data-animation]");
            slideLayer.each(function () {
                var anim_name = $(this).data('animation');
                $(this).removeClass('animated ' + anim_name).css('opacity', '0');
        ...
        gameSlide.on('translated.owl.carousel', function () {
            var slideLayer = gameSlide.find('.owl-item.active').find("[data-animation]");
            slideLayer.each(function () {
                var anim_name = $(this).data('animation');
                $(this).addClass('animated ' + anim_name).css('opacity', '1');
            });
